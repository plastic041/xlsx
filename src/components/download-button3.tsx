...
import { createExcelFileStyle3, downloadXlsxStyle } from "../lib/excel2";
  ...
  return (
    <button
      onClick={async () => {
        ...
        setState("creating");
        const excelFile = createExcelFileStyle3(data, deliveryAddress);

        setState("downloading");
        downloadXlsxStyle(excelFile, `${deliveryAddress}.xlsx`);
